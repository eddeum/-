...
public class Member { // 데이터 모델
	...
	public static void sendmail(String 받는사람이메일, String 내용 ) {
		// 1. 보내는 사람 정보
		String 보내는사람이메일 = "qweqwe@naver.com";
		String 보내는사람이메일비밀번호 = "1234";
		// 2. 호스트 설정
		Properties properties = new Properties(); // 컬렉션프레임워크[map컬렉
		...
		// 3. 인증처리[Seesion : java.mail 패키지 사용]
		...
		// 4. 메일 보내기
		try {
			MimeMessage message = new MimeMessage(session); // Mime 프로토콜 : 전자우편 표준 포맷 
