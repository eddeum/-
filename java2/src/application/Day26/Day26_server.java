	...
	public static void main(String[] args) {
		...
		try {	// 1. 서버소켓 만들기
			...
			while(true) {
				...
				System.out.println("[[클라이언트와 연결이 되었습니다. 연결된 클라이언트정보 : "+socketAddress.getHostName() );
				...
				System.out.println("클라이언트에게 보낼 메시지 : ");	String msg = scanner.nextLine();
					// 2. 소켓의 출력 스트림
