...
public class Day19_5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(scores.lower(95)); // 87 	= 95 기준으로 왼쪽 노드 호출[95보다 작은]
		System.out.println(scores.higher(95)); // 98 	= 95 기준으로 오른쪽 노드 호출[95보다 큰]
		System.out.println(scores.floor(95)); // 95		= 95포함 기준으로 왼쪽 노드[95와 같거나 작은]
		System.out.println(scores.ceiling(85)); // 87	= 85포함 기준으로 오른쪽 노드[85와 같거나 큰]
		// 4. 삭제
