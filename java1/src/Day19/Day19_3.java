...
public class Day19_3 {
	...
	public static void main(String[] args) {
		...
		// 1. Map 컬렉션 = json
			...
			// * List 컬렉션 : 순서(인덱스) 저장 = 배열과 유사
			// * Set 컬렉션 : 순서없는 저장 = 중복불가능
			// * Map 컬렉션 : 키(set)와 값(list)으로 이루어진 엔트리를 여러개 저장[순서 X]
		
		// 1. HashMap 클래스의 객체 선언
		HashMap<String, Integer> map = new HashMap<>();
// HashMap : 컬렉션프레임워크 map 클래스
	// <제네릭, 제네릭> : key, value와 구성된 제네릭
		// map : map 객체명(아무거나)
			// new : 객체 생성시 메모리할당
				// HashMap<>() : 생성자
		// 2. map 객체에 추가
		...
		// * key는 중복불가능[기존 key 없어지고 새로운 키로 대치]
		...
		// 7. 반복문[key를 반복문 이용해서 모든 value 호출 가능]
