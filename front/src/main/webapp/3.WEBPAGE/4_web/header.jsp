	...
	<div class="container"> <!-- 박스권 형성 -->
		<div class="py-3"> <!-- 상단 메뉴 -->
			...
			<div class="row"> <!-- 가로 배치 -->
				...
				<div class="col-md-4 offset-4 text-center" > <!-- 로고 [그리드 12조각 중 4조각사용] -->
								<!-- offset-4 : 여백 그리드(4) -->
										<!-- text-center : 박스권 내 내용물 가운데 정렬 -->
					<a href="main.jsp" class="header_logo"> 안산 쇼핑몰 </a> <!-- 링크 -->
				</div>
		...
		<div class="navbar navbar-expand-md navbar-light bg-white"> <!-- 본 메뉴 -->
			...
			<div class="collapse navbar-collapse" id="navcl"> <!-- 사이즈가 부족할경우 아래 ul 숨기기 -->
