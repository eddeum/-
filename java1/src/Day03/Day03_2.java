...
//			// 만약에 입력받은 정수1변수가 정수2변수 보다 크면 실행 아니면 아래로(다음조건)
//		else if(정수1<정수2)	System.out.println("더 큰수 : " + 정수2);
//			// [다음조건] 정수1변수가 정수2변수 보다 작으면 실행 아니면 그 외
//		else				System.out.println("같다");
//			// 나머지[그 외] 실행
//		
//		// 문제2 : 3개의 정수를 입력받아서 더 큰수 출력
//		System.out.print("정수1 입력 : ");		int	정수3 = scanner.nextInt();	// 변수명 중복x
//		System.out.print("정수2 입력 : ");		int	정수4 = scanner.nextInt();
//		System.out.print("정수3 입력 : ");		int	정수5 = scanner.nextInt();
...
//			// └ 정수4 = max;
//			// └ max = temp;
//			// 만약에 max 보다 정수4가 더 크면 max 교체
//		if(max<정수5) {max = 정수5;}
//		System.out.println("가장 큰수 : " + max);
//		
//		// 문제3 : 4개의 정수를 입력받아서 더 큰수 출력
//		System.out.print("정수1 입력 : ");		int	정수6 = scanner.nextInt();
//		System.out.print("정수2 입력 : ");		int	정수7 = scanner.nextInt();
//		System.out.print("정수3 입력 : ");		int	정수8 = scanner.nextInt();
//		System.out.print("정수4 입력 : ");		int	정수9 = scanner.nextInt();
//		int max2 = 정수6;
...
//		
//		// 문제4 : 3개의 정수를 입력받아서 오름차순(내림차순 : 부호만 > -> <로 바꾸면됨)
//		System.out.print("정수1 입력 : ");		int	정수10 = scanner.nextInt();
//		System.out.print("정수2 입력 : ");		int	정수11 = scanner.nextInt();
//		System.out.print("정수3 입력 : ");		int	정수12 = scanner.nextInt();
//		
//		if(정수10>정수11) {	// > : 오름차순 < : 내리차순
//			// 교체[스왑 = 두 개 변수에 데이터 교환방법]
...
//		// └ 또 다른 방법 : System.out.println("입력한 값 오름차순 :" + 정수10 + " " + 정수11 + " " + 정수12);
		
		// 문제5 : 4개의 정수를 입력받아서 내림차순
		System.out.print("정수1 입력 : ");		int	정수13 = scanner.nextInt();
		System.out.print("정수2 입력 : ");		int	정수14 = scanner.nextInt();
		System.out.print("정수3 입력 : ");		int	정수15 = scanner.nextInt();
		System.out.print("정수4 입력 : ");		int	정수16 = scanner.nextInt();
		// 첫번째 값 기준으로 비교
