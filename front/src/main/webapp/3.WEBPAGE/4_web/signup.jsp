...
<body>
	...
	<div class="container row col-md-8 offset-2">
		<div class="col-md-6">ㄴ
			...
			<div> <span style="font-size: 20px; font-weight: bold;"> 회원가입 약관동의 </span> <span  style="font-size: 20px; font-weight: bold; color: red;">*</span> </div>
			<textarea class="form-control text-start" rows="8" cols="65" style="font-size: 16px;">
제 1장 총칙
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.
			...
			<div class="signupline" style="border-bottom: solid 2px #eeeeee; width: 590px;"></div><br>
			<div> <span style="font-size: 20px; font-weight: bold;"> 개인정보처리방침 </span> <span  style="font-size: 20px; font-weight: bold; color: red;">*</span> </div>
			<textarea class="form-control text-start" rows="8" cols="65" style="font-size: 16px;">
가. 개인정보의 수집 및 이용 목적
...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.
		...
		<div class="col-md-6"> <!-- 회원가입 입력창 -->
			<form>
				...
				<div>
					<input type="password" class="form-control" placeholder="한번더 비밀번호를 입력하세요.*">
				</div><br>
				<div>
					<input type="text" class="form-control" placeholder="이름을 입력하세요.*">
				</div><br>
				<div style="text-align: center">
					 <input type="radio" class="form-check-input name" checked="checked"> 남자</span>
					<input type="radio" class="form-check-input nmae">여자 </span>		
				</div><br>
				<div>
					<input type="text" class="form-control" placeholder="연락처를 입력하세요.*">
				</div><br>
				<div>
					<input type="text" class="form-control" placeholder="이메일을을 입력하세요.*">
				</div><br>
				<div>
