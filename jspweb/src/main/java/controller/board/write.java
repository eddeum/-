...
public class write extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 저장 경로[\ : 제어문자이므로 -> 경로 사용시 \\ or /]
			// 1. 개발중인 프로젝트 경로
		//String uploadpath = "C:/Users/504/git/java/jspweb/src/main/webapp/board/upload";
			// 2. 서버 폴더 경로
				// 서버 경로 찾기 : getSession().getServletContext().getRealPath(경로);
		...
		// 객체화
		Board board = new Board(0, btitle, bcontent, mnum, 0, null, bfile, null);
