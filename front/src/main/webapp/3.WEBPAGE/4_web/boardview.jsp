...
<body>
	...
	<div class="container">
		...
		<div>
			<textarea rows="20" cols="" class="form-control" readonly style="resize: none;">하하하하하하하하하ㅏ하하</textarea>
																		<!-- textarea 크기고정 -->
		</div>
		...
		<!-- 관리자가 답변한 내용 -->
		<h4>답변</h4>
		<p>답변일 : 2022-04-25 12:10</p>
		<div>
			<textarea rows="" cols="" class="form-control" readonly style="resize: none;">호호호호호호호호호호호호</textarea>
		</div>
