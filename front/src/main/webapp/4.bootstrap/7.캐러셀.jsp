...
<title>Insert title here</title>
	...
	<style type="text/css">
		.carousel-item{ /*이미 정의된 부트스트랩 클래스 수정가능*/
			width: 100%;
			height: 100%;
		}
	</style>
...
<body>
	...
	<div class="container"> <!-- 박스권 -->
		...
		<!-- 캐러셀 -->
		<div id="cs" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000"> <!-- data-bs-interval : 밀리초(1/1000초) -->
				...
				<div class="carousel-inner">		
					...
					<div class="carousel-item active">	
						...
						<div class="carousel-caption">테스트중입니다....!</div>
					</div>
