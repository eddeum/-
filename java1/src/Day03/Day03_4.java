...
public class Day03_4 { //cs
	...
	public static void main(String[] args) { //ms
		...
		// 제어문 : 1. if문 2. switch문
			// if : 논리검사(true 혹은 false)	/ 경우의 수가 정해져 있지 않는 경우
				// >= <= > < == != 사용
			// switch : 데이터검사(선택조건)		/ 경우의 수가 정해져 있는 경우
...
//			}
			...
			switch(평균/10) {
				...
				case 8 : System.out.println("A등급"); break;	
