...
public class Day13_1 {
	...
	public static void main(String[] args) {
		...
		// 4. Math.max(수1, 수2) : 두 수 중에 큰수를 출력
		System.out.println("최댓값 : " + Math.max(5,9)); // 9	
		System.out.println("최댓값 : " + Math.max(5.3, 2.5)); // 5.3
		// 5. Math.min(수1, 수2) : 두 수 중에 작은수를 출력
		System.out.println("최솟값 : " + Math.min(5, 9)); // 5
		System.out.println("최솟값 : " + Math.min(5.3, 2.5)); // 2.5
		// 6. Math.random() : 0~1 사이의 double형 난수발생
		System.out.println("난수 : " + Math.random()); // 0 ~ 1 사이의 난수발생
		// 7. Math.rint(수) : 가까운 정수의 실수값으로 반올림
		System.out.println("가까운 정수의 실수값 : " + Math.rint(5.3)); // 5.0 -> 반올림
		System.out.println("가까운 정수의 실수값 : " + Math.rint(5.7)); // 6.0 -> 반올림
		// 8. Math.round(수) : 가까운 정수의 정수값으로 반올림
		System.out.println("가까운 정수의 정수값 : " + Math.round(5.3)); // 5 -> 반올림
		System.out.println("가까운 정수의 정수값 : " + Math.round(5.7)); // 6 -> 반올림
		...
		// p.536 : 주사위[1~6]
		System.out.println("0~1사이의 실수형 : " + Math.random()); // 0~1(0~0.99999 값)
		System.out.println(Math.random()*6); // 0~1 *6 -> 0~6(사이값)
		System.out.println(Math.random()*6 + 1); // 0~1 *6 +1 -> 1~7(사이값)
		int num = (int)(Math.random()*6)+1;
				// (기본자료형) 값/변수 = 강제형변환(큰상자->작은상자 : 데이터손실o)
				// double -> int 강제형변환시 -> 소수점잘림
		System.out.println("1~7사이의 난수 : " + num);
		/////////////////////////////////////////////////////////////////////////////////
