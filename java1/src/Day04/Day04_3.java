...
public class Day04_3 { // c s
	...
	public static void main(String[] args) { // m s
		...
		// 준비
		int 플레이어; 	// 사용자가 선택한 수
		int 컴퓨터; 	// 컴퓨터가 난수를 생성한 수
		int 게임수 = 0;	// 총 가위바위보 실행 횟수
		int 플레이어승리수 = 0;	int 컴퓨터승리수 = 0;	// 각 승리 수
		...
		// 종료 조건
			if(플레이어==3) {
				...
				else if((플레이어==0 && 컴퓨터==0) || (플레이어==1 && 컴퓨터==1) || (플레이어==2 && 컴퓨터==2)) { // 비기는 경우의 수
