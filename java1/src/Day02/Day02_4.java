...
public class Day02_4 { // c s
	...
	public static void main(String[] args) { // m s
		 ...
		 *  			// 2. 변수에 10을 더한다.
		 *  			// 3. 해당 변수에 더한값을 대입
		 *  		변수명 += 10 (위와 동일하지만 목적은 코드를 줄임(속도가빨라짐))
		 *  			// 1. 변수를 호출
		 ...
		 *  5. 증감[* : 일정간격으로 변화]
		 *  	// 1. ++ : 1증가			2. -- : 1감소
		 *  	// 선위증가/감소 : 먼저 증가/감소하고 다른 명령 처리		
		 *  	// 후위증가/감소 : 다른 명령어를 처리후에 증가/감소
		 *  6. 상항연산자[조건연산자]
		 *  	조건식 ? 참 : 거짓
		 */
		...
		System.out.println("증가 : " + 정수1);			// 11 출력
		정수1--; // 변수명뒤에 -- 할 경우 해당 변수내 데이터에 -1
		System.out.println("감소 : " + 정수1);			// 10 출력
		...
		System.out.println("선위감소 : " + --정수1); 	// 1감소 후 출력 => 11출력
		System.out.println("후위감소 : " + 정수1--); 	// 출력 후에 1감소 => 11출력
		...
		char 등급2 = 점수 > 90 ? 'A' : 점수 > 90 ? 'B' : 'C';
					// 조건식 ? 참 : 거짓[조건식 ? 참 : 거짓]
					// 점수변수가 90을 초과하면 A 아니면 점수변수가 80 초과하면 B 둘다 아니면 C
	} // m e
