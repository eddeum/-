...
public class filedown extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String bfile = request.getParameter("bfile");	// 2. 변수 요청
		
		// 3. 서버에서 해당 파일 찾기[서버내 경로 찾기]
		String uploadpath = request.getSession().getServletContext().getRealPath("/board/upload/"+bfile);
		// 프로젝트 경로 찾기
		//String uploadpath = "C:/Users/504/git/java/jspweb/src/main/webapp/board/upload"+bfile;
